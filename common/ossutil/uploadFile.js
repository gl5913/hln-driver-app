...
const uploadFile = function (filePath, dir, successc, failc) {
  ...
  uni.uploadFile({
    ...
    success: function (res) {
			console.log(res);
			uni.showToast({title:res.statusCode,icon: "success",duration:2000})
      ...
      if (res.statusCode != 200) {
		  data.code = -1
		  data.data = '上传错误:' + JSON.stringify(res)
        successc(data)
        return;
      }
	  data.data="https://songgete.oss-accelerate.aliyuncs.com/"+aliyunFileKey
       successc(data);
    },
    fail: function (err) {
